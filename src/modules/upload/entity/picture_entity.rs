...
pub struct Picture {
    ...
    pub forbidden: i8,
    ///邮箱验证
    pub valid_email: Option<String>,
    ///首次登录标记
    pub is_first_login: Option<String>,
    ///赞同数量
    pub agree_count: i32,
    ///感谢数量
    ...
    pub url_token_update: Option<String>,
    pub verified: Option<String>,
    pub default_timezone: Option<String>,
    pub email_settings: Option<String>,
    pub weixin_settings: Option<String>,
    pub recent_topics: Option<String>,
    ///主题
